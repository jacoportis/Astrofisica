...
% variabili
\newcommand{\imagebig}{0.9\textwidth}
\newcommand{\initcolor}{purple}

% riferimenti
\newcommand{\figref}[1]{Fig.~\ref{#1}}
\newcommand{\pfigref}[1]{(\figref{#1})}
\newcommand{\cfr}[1]{(\textit{cfr.}~\S~\ref{#1})}
...
\begin{document}
    ...
    \mainmatter
        ...
        \input{chapters/telescopi}
        \input{chapters/fotometria}
        \input{chapters/spettroscopia}
